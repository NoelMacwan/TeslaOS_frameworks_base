...
public final class Settings {
    ...
    /**
     * @hide - Private call() method on SettingsProvider to read from 'tesla' table.
     */
    public static final String CALL_METHOD_GET_TESLA = "GET_tesla";
    ...
    /** @hide - Private call() method to write to 'tesla' table */
    public static final String CALL_METHOD_PUT_TESLA = "PUT_tesla";
    ...
    /**
     * TESLA settings, containing TESLA specific preferences.  This
     * table holds simple name/value pairs.  There are convenience
     * functions for accessing individual settings entries.
     */
    public static final class TESLA extends NameValueTable {
        public static final String SYS_PROP_SETTING_VERSION = "sys.settings_system_version";
         ...
         */
        public static final Uri CONTENT_URI =
            Uri.parse("content://" + AUTHORITY + "/tesla");

        private static final NameValueCache sNameValueCache = new NameValueCache(
                SYS_PROP_SETTING_VERSION,
                CONTENT_URI,
                CALL_METHOD_GET_TESLA,
                CALL_METHOD_PUT_TESLA);
