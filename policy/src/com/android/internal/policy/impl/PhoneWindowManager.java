...
import com.android.internal.util.tesla.Converter;
...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.TESLA.getUriFor(
                    Settings.TESLA.NAVIGATION_BAR_HEIGHT), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.TESLA.getUriFor(
                    Settings.TESLA.NAVIGATION_BAR_HEIGHT_LANDSCAPE), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.TESLA.getUriFor(
                    Settings.TESLA.NAVIGATION_BAR_WIDTH), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
    ...
    public void updateSettings() {
        ...
        synchronized (mLock) {
            ...
            int mNavigationBarHeight = Settings.TESLA.getIntForUser(mContext.getContentResolver(),
                    Settings.TESLA.NAVIGATION_BAR_HEIGHT, -2, UserHandle.USER_CURRENT);
            ...
            int mNavigationBarHeightLandscape = Settings.TESLA.getIntForUser(mContext.getContentResolver(),
                    Settings.TESLA.NAVIGATION_BAR_HEIGHT_LANDSCAPE, -2, UserHandle.USER_CURRENT);
            ...
            int mNavigationBarWidth = Settings.TESLA.getIntForUser(mContext.getContentResolver(),
                    Settings.TESLA.NAVIGATION_BAR_WIDTH, -2, UserHandle.USER_CURRENT);
