...
public class NetworkTraffic extends TextView {
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            Uri uri = Settings.TESLA.getUriFor(Settings.TESLA.NETWORK_TRAFFIC_STATE);
            resolver.registerContentObserver(uri, false,
                    this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.TESLA
                    .getUriFor(Settings.TESLA.NETWORK_TRAFFIC_AUTOHIDE), false,
                    this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.TESLA
                    .getUriFor(Settings.TESLA.NETWORK_TRAFFIC_AUTOHIDE_THRESHOLD), false,
                    this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.TESLA
                    .getUriFor(Settings.TESLA.NETWORK_TRAFFIC_COLOR), false,
                    this, UserHandle.USER_ALL);
        }
    ...
    private void updateSettings() {
        ...
        mAutoHide = Settings.TESLA.getIntForUser(resolver,
                Settings.TESLA.NETWORK_TRAFFIC_AUTOHIDE, 0,
                UserHandle.USER_CURRENT) == 1;

        mAutoHideThreshold = Settings.TESLA.getIntForUser(resolver,
                Settings.TESLA.NETWORK_TRAFFIC_AUTOHIDE_THRESHOLD, 10,
                UserHandle.USER_CURRENT);

        mState = Settings.TESLA.getInt(resolver, Settings.TESLA.NETWORK_TRAFFIC_STATE, 0);

        int defaultColor = Settings.TESLA.getInt(resolver,
                Settings.TESLA.NETWORK_TRAFFIC_COLOR, 0xFFFFFFFF);

        int mNetworkTrafficColor = Settings.TESLA.getInt(resolver,
                Settings.TESLA.NETWORK_TRAFFIC_COLOR, -2);
