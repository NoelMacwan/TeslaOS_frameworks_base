...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode,
    ...
    final private ContentObserver mHeadsUpObserver = new ContentObserver(mHandler) {
        ...
        public void onChange(boolean selfChange) {
            ...
            mUseHeadsUp = ENABLE_HEADS_UP && !mDisableNotificationAlerts && Settings.TESLA.getIntForUser(
                    mContext.getContentResolver(),
                    Settings.TESLA.HEADS_UP_NOTIFICATION, 1, UserHandle.USER_CURRENT) == 1;
    ...
    public void start() {
        ...
        if (ENABLE_HEADS_UP) {
            mContext.getContentResolver().registerContentObserver(
                    Settings.TESLA.getUriFor(Settings.TESLA.HEADS_UP_NOTIFICATION), true,
